...
|------|-------------|------|---------|:--------:|
| <a name="input_cluster_name"></a> [cluster\_name](#input\_cluster\_name) | EKS cluster name MNG | `string` | n/a | yes |
...
| <a name="input_subnet_private_1c"></a> [subnet\_private\_1c](#input\_subnet\_private\_1c) | Subnet ID from AZ 1c | `string` | n/a | yes |
